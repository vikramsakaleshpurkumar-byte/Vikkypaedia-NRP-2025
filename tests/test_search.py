...
with sync_playwright() as pw:
    ...
    print("\n== RESULTS ==")
    p.fill("#srchInput","meconium"); p.wait_for_timeout(400)
    ...
    print("\n== LOCKED UNITS ==")
    p.fill("#srchInput","laryngeal mask"); p.wait_for_timeout(450)
    ...
    print("\n== NAVIGATION ==")
    p.fill("#srchInput","sniffing position"); p.wait_for_timeout(450)
    ...
    p.fill("#srchInput","transition pyramid"); p.wait_for_timeout(450)
