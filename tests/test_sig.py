...
SKIP=("try{var K='vkp.nrp2025.v1';var r=localStorage.getItem(K);"
...
with sync_playwright() as pw:
    ...
    alpha=p.evaluate("""async()=>{const s=JSON.parse(localStorage.getItem('vkp.nrp2025.v1'));
    ...
    check("cleared from storage", p.evaluate("()=>{const s=JSON.parse(localStorage.getItem('vkp.nrp2025.v1'));return !(s.settings&&s.settings.signPhoto);}"))
